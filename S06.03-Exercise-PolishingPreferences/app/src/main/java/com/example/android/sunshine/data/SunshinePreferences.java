...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String location = preferences.getString(context.getString(R.string.pref_location_key), DEFAULT_MAP_LOCATION);
        return location;
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        /** This will be implemented in a future lesson **/
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        boolean isMetric = preferences.getString(context.getString(R.string.pref_units_key), "").equals(context.getString(R.string.pref_units_metric));
        return isMetric;
    }
