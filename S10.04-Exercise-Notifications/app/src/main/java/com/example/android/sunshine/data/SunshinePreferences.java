...
public final class SunshinePreferences {
    ...
    public static boolean isNotificationEnabled(Context context) {
        ...
        boolean defaultValue = context.getResources().getBoolean(R.bool.show_notification_default);
        boolean notificationEnabled = PreferenceManager.getDefaultSharedPreferences(context).getBoolean(key, defaultValue);
