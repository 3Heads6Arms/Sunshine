...
public class SunshineSyncUtils {
    ...
    private static final int WEATHER_SYNC_HOURS = 3;
    private static final int WEATHER_SYNC_SECONDS =  5;//(int) TimeUnit.HOURS.toSeconds(WEATHER_SYNC_HOURS);
    private static final int SYNC_FLEX = 10;//WEATHER_SYNC_SECONDS + (int) TimeUnit.HOURS.toSeconds(1);

    private static boolean sInitialized;

    //  COMPLETED (11) Add a sync tag to identify our sync job
    private static final String mSyncTag = "weather_sync_tag";
    ...
    private static void scheduleWeatherSync(Context context) {
        ...
        Job job = jobDispatcher
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(WEATHER_SYNC_SECONDS, SYNC_FLEX))
